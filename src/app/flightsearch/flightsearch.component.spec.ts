  ...
  [
    {
      ...
      seats: [
        { price: 100.0, seatClass: 'ECONOMY', seatStatus: 'AVAILABLE' },
        { price: 100.0, seatClass: 'BUSINESS', seatStatus: 'AVAILABLE' },
      ],
      airplane: {
        name: 'Boeing 747',
      },
...
describe('FlightsearchComponent', () => {
  ...
  it('should create', () => {
    fixture = TestBed.createComponent(FlightsearchComponent);
    component = fixture.componentInstance;
    TestBed.inject(ActivatedRoute).queryParams = of(data);
    fixture.detectChanges();
  ...
  it('should do two GET requests: one for flights, and one for servicing area //flights error', () => {
    ...
    const baseURL =
      environment.flightsEndpoint +
      '/flight-search?origin=D.C&' +
  ...
  it('Going through ternary operators for from airport, null', () => {
    fixture = TestBed.createComponent(FlightsearchComponent);
    component = fixture.componentInstance;
    TestBed.inject(ActivatedRoute).queryParams = of({ origin: null });
    fixture.detectChanges();
  ...
  it('Going through ternary operators for from airport, included', () => {
    fixture = TestBed.createComponent(FlightsearchComponent);
    component = fixture.componentInstance;
    TestBed.inject(ActivatedRoute).queryParams = of({ origin: 'D.C' });
    fixture.detectChanges();
  ...
  it('Going through ternary operators for to airport, null', () => {
    fixture = TestBed.createComponent(FlightsearchComponent);
    component = fixture.componentInstance;
    TestBed.inject(ActivatedRoute).queryParams = of({ destinations: null });
    fixture.detectChanges();
  ...
  it('Going through ternary operators for to airport, included', () => {
    fixture = TestBed.createComponent(FlightsearchComponent);
    component = fixture.componentInstance;
    TestBed.inject(ActivatedRoute).queryParams = of({ destinations: 'LA' });
    fixture.detectChanges();
  ...
  it('Going through ternary operators for from calendar, null', () => {
    fixture = TestBed.createComponent(FlightsearchComponent);
    component = fixture.componentInstance;
    TestBed.inject(ActivatedRoute).queryParams = of({ departure: null });
    fixture.detectChanges();
  ...
  it('Going through ternary operators for from calendar, badinput', () => {
    fixture = TestBed.createComponent(FlightsearchComponent);
    component = fixture.componentInstance;
    TestBed.inject(ActivatedRoute).queryParams = of({ departure: 'bad-input' });
    fixture.detectChanges();
  ...
  it('Going through ternary operators for to calendar, null', () => {
    fixture = TestBed.createComponent(FlightsearchComponent);
    component = fixture.componentInstance;
    TestBed.inject(ActivatedRoute).queryParams = of({ return: null });
    fixture.detectChanges();
  ...
  it('Going through ternary operators for to calendar, badinput', () => {
    fixture = TestBed.createComponent(FlightsearchComponent);
    component = fixture.componentInstance;
    TestBed.inject(ActivatedRoute).queryParams = of({ return: 'bad-input' });
    fixture.detectChanges();
    //hello
    expect(component.viewData).toEqual([]);
    expect(component.noResultsErrorMsg).toEqual('Input Error');
  ...
  it('Going through ternary operators for to calendar, included', () => {
    fixture = TestBed.createComponent(FlightsearchComponent);
    component = fixture.componentInstance;
    TestBed.inject(ActivatedRoute).queryParams = of({ return: '2021-10-12' });
    fixture.detectChanges();
  ...
  it('Going through ternary operators for adults, null', () => {
    fixture = TestBed.createComponent(FlightsearchComponent);
    component = fixture.componentInstance;
    TestBed.inject(ActivatedRoute).queryParams = of({ adults: null });
    fixture.detectChanges();
  ...
  it('Going through ternary operators for adults, included', () => {
    fixture = TestBed.createComponent(FlightsearchComponent);
    component = fixture.componentInstance;
    TestBed.inject(ActivatedRoute).queryParams = of({ adults: 2 });
    fixture.detectChanges();
  ...
  it('Going through ternary operators for children, null', () => {
    fixture = TestBed.createComponent(FlightsearchComponent);
    component = fixture.componentInstance;
    TestBed.inject(ActivatedRoute).queryParams = of({ children: null });
    fixture.detectChanges();
  ...
  it('Going through ternary operators for children, included', () => {
    fixture = TestBed.createComponent(FlightsearchComponent);
    component = fixture.componentInstance;
    TestBed.inject(ActivatedRoute).queryParams = of({ children: 2 });
    fixture.detectChanges();
  ...
  it('Going through ternary operators for multihop, null', () => {
    fixture = TestBed.createComponent(FlightsearchComponent);
    component = fixture.componentInstance;
    TestBed.inject(ActivatedRoute).queryParams = of({ multiHop: null });
    fixture.detectChanges();
  ...
  it('Going through ternary operators for multihop, included', () => {
    fixture = TestBed.createComponent(FlightsearchComponent);
    component = fixture.componentInstance;
    TestBed.inject(ActivatedRoute).queryParams = of({ multiHop: 'true' });
    fixture.detectChanges();
  ...
  it('processGetResults but no standardize results', () => {
    ...
    let fakeRes = {
      'Origin to destination': [1, 2, 3, 4, 5],
  ...
  it('processGetResults but standardize results but destination to origin exists', () => {
    ...
    processedInfo = processedInfo.sort(
      (a, b) =>
        b.basePrice.replace(/[$,]+/g, '') - a.basePrice.replace(/[$,]+/g, '')
    );
    ...
    let fakeRes = {
      'Origin to destination': [1, 2, 3, 4, 5],
      'Destination to origin': [1, 2, 3, 4, 5],
    };
    component.processGetResults(fakeRes);
  ...
  it('sort most recent', () => {
    ...
    expect(component.viewData[0].creationTime).toEqual(
      '2021-03-17T17:30:56.760945-04:00'
    );
  });
  ...
  it('sort oldest', () => {
    ...
    expect(component.viewData[0].creationTime).toEqual(
      '2021-03-15T17:30:56.760945-04:00'
    );
  });
  ...
  it('test eventSort', () => {
    ...
    let specificElement = document.getElementById(
      'PriceLowToHigh'
    ) as HTMLElement;
  ...
  it('test reclicking on same sort eventSort', () => {
    ...
    component.eventSort('cheapest', 'PriceLowToHigh');
    let updatedElement = document.getElementById(
      'PriceLowToHigh'
    ) as HTMLElement;
